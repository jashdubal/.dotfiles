...
vim.api.nvim_set_keymap('n', '<C-p>', ':!python3 %<CR>', { noremap = true, silent = true })

vim.api.nvim_set_keymap('n', '<CR>', 'o', { noremap = true, silent = true })

vim.api.set_keymap('n', '<C-s>', ':w<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', '<M-Up>', ':silent! normal! gg<CR>', { noremap = true, silent = true })

-- Option+Down: Go to the bottom of the buffer
vim.api.nvim_set_keymap('n', '<M-Down>', ':silent! normal! G<CR>', { noremap = true, silent = true })

-- Option+Left: Go to the end of the line
vim.api.nvim_set_keymap('n', ',', ':silent! normal! ^<CR>', { noremap = true, silent = true })

-- Option+Right: Go to the start of the line
vim.api.nvim_set_keymap('n', '.', ':silent! normal! $<CR>', { noremap = true, silent = true })

vim.api.nvim_set_keymap('n', '<C-f>', ':%s///g<Left><Left>', { noremap = true, silent = true })
